...
type NodePoolNetworkConfigInitParameters struct {
	...
	NetworkPerformanceConfig *NodePoolNetworkConfigNetworkPerformanceConfigInitParameters `json:"networkPerformanceConfig,omitempty" tf:"network_performance_config,omitempty"`
...
type NodePoolNetworkConfigNetworkPerformanceConfigObservation struct {

	// Specifies the total network bandwidth tier for the NodePool. Valid values include: "TIER_1" and "TIER_UNSPECIFIED".
	TotalEgressBandwidthTier *string `json:"totalEgressBandwidthTier,omitempty" tf:"total_egress_bandwidth_tier,omitempty"`
}

type NodePoolNetworkConfigNetworkPerformanceConfigParameters struct {
...
type NodePoolNetworkConfigObservation struct {
	...
	// Network bandwidth tier configuration. Structure is documented below.
	NetworkPerformanceConfig *NodePoolNetworkConfigNetworkPerformanceConfigObservation `json:"networkPerformanceConfig,omitempty" tf:"network_performance_config,omitempty"`
...
type NodePoolNetworkConfigParameters struct {
	...
	// Network bandwidth tier configuration. Structure is documented below.
	// +kubebuilder:validation:Optional
	NetworkPerformanceConfig *NodePoolNetworkConfigNetworkPerformanceConfigParameters `json:"networkPerformanceConfig,omitempty" tf:"network_performance_config,omitempty"`
...
type NodePoolNodeConfigEphemeralStorageConfigInitParameters struct {
	LocalSsdCount *float64 `json:"localSsdCount,omitempty" tf:"local_ssd_count,omitempty"`
}

type NodePoolNodeConfigEphemeralStorageConfigObservation struct {
	LocalSsdCount *float64 `json:"localSsdCount,omitempty" tf:"local_ssd_count,omitempty"`
}

type NodePoolNodeConfigEphemeralStorageConfigParameters struct {
...
type NodePoolNodeConfigInitParameters_2 struct {
	...
	EphemeralStorageConfig *NodePoolNodeConfigEphemeralStorageConfigInitParameters `json:"ephemeralStorageConfig,omitempty" tf:"ephemeral_storage_config,omitempty"`
...
type NodePoolNodeConfigObservation_2 struct {
	...
	EphemeralStorageConfig *NodePoolNodeConfigEphemeralStorageConfigObservation `json:"ephemeralStorageConfig,omitempty" tf:"ephemeral_storage_config,omitempty"`
...
type NodePoolNodeConfigParameters_2 struct {
	...
	// +kubebuilder:validation:Optional
	EphemeralStorageConfig *NodePoolNodeConfigEphemeralStorageConfigParameters `json:"ephemeralStorageConfig,omitempty" tf:"ephemeral_storage_config,omitempty"`
...
type NodePoolParameters_2 struct {
	...
	// The cluster to create the node pool for. Cluster must be present in location provided for clusters. May be specified in the format projects/{{project}}/locations/{{location}}/clusters/{{cluster}} or as just the name of the cluster.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp-beta/apis/namespaced/container/v1beta1.Cluster
	// +crossplane:generate:reference:extractor=github.com/upbound/provider-gcp-beta/config/namespaced/common.ExtractResourceID()
	// +kubebuilder:validation:Optional
	Cluster *string `json:"cluster,omitempty" tf:"cluster,omitempty"`
