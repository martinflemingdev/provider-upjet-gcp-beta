...
type FeaturestoreEntitytypeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp-beta/apis/namespaced/vertexai/v1beta1.Featurestore
	...
	OfflineStorageTTLDays *float64 `json:"offlineStorageTtlDays,omitempty" tf:"offline_storage_ttl_days,omitempty"`
}
...
type SnapshotAnalysisInitParameters struct {
	...
	MonitoringInterval *string `json:"monitoringInterval,omitempty" tf:"monitoring_interval,omitempty"`
